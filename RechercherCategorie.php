     ...
     <!-- /gestion des livraisons/livreurs-->
      ...
      <li class="menu-item">
        ...
        <ul id="Livreur-page" class="collapse" aria-labelledby="Livreur-page" data-parent="#side-nav-accordion">
          ...
          <li> <a href="ModifierLivreur.html">Modifier Un livreur</a> </li>
          <li> <a href="SupprimerLivreur.html">Supprimmer Un livreur</a> </li>
          <li> <a href="AfficherLivreur.html"> Afficher les livreurs</a> </li>
